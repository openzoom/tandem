...
public class ZoomModel extends EventDispatcher
{
    ...
    public function zoomBy( value : Number, originX : Number = 0.5, originY : Number = 0.5  ) : void
    {
    	zoomTo( zoom * value, originX, originY )
    }
    
    public function zoomTo( value : Number, originX : Number = 0.5, originY : Number = 0.5  ) : void
    {
        _zoom = value
    ...
    {        	
        ...
        dispatchEvent( new ZoomModelEvent( ZoomModelEvent.CHANGE ) )
    }
    ...
    private function getViewportOrigin( originX : Number, originY : Number ) : Point
    {
